...
<div class='menu'>
  ...
  <span class='toggle'>
    ...
    <div class='menuContent'>
        <ul>
            <li><a href="HomeLI.html">Home</a></li>
            <li><a href="CarsLI.php" class="active">Cars</a></li>
            <li><a href="AboutUsLI.html">About Us</a></li>
...
<div id="searchpanel">
    ...
    <div class="box">
        <input type="text" id="search" placeholder="Enter Car Name..." name="" onkeyup="ajaxfn()">
        <input type="submit" id="searchbtn" name="" value="Search">
    </div>
</div>
...
<div id="list">
							...
							<div class="car">
								...
								<div class="details">
									<div class="content">
										...
										<input type="button" value="Book Now" onclick="PopUp1(<?php echo $rows['CarId'] ?>)">
										<input type="button" value="Subscribe" onclick="PopUp2(<?php echo $rows['CarId'] ?>)">
									</div>
								</div>
							</div>
						</div>
	...
	<script>
			...
			function PopUp1(id)
			{
				location.assign('BookCar.php?cid='+id);
...
<div id="popup2" class="overlay">
    <div class="title"><h2>Car Subscribe Form</h2></div>
                ...
                <div class="right">
                    <div class="formbox">
                        <form>
                            ...
                            <input type="button" name="" value="Submit" id="popbtn">
                        </form>
                    </div>
                </div>
